...
public class Fact {
    ...
    private static String[] fact = {
            ...
            "Recycling aluminium can help to save a great deal of energy; in fact, enough to run your home television for about three hours!",
            ...
            "The average person has the opportunity to recycle more than 25000 aluminium cans in their life.",
            ...
            "Due to the fact that people aren’t recycling as much as they should, the rainforests are actually getting cut down by about 404685 square meters a minute.",
            "Recycling just one ton of paper saves 26497 litres of water.",
            ...
            "Plastic bags and garbage that are thrown into the ocean have a devastating effect on sea animals.",
            "Over 25 trillion Styrofoam coffee cups are thrown away each year, just by Americans!",
            "Styrofoam produced from Polystyrene never decomposes. The world produces more than 14 million tons of Polystyrene (plastic foam) each year.",
            ...
            "Over 60% of the trash that ends in the dustbin could be recycled.",
            "One drip one second from a leaky faucet wastes 2000 litres of water a year."
    };
